...
class CF_FindMappingAtModulus(CodeletFamily):
    ...
    def Run(cls, controller, modulus, *, me):
        ...
        if maximum_k <= 1:
            ...
            return
        known_relations = list(cls.GetRelations(
            parent_workspace, a, d, maximum_k))
    ...
    def GetRelations(cls, parent_workspace, a, d, maximum_k):
        for leftward_element_position in range(a, a + d * maximum_k, d):
            ...
            right_element = parent_workspace.elements[
                rightward_element_position]
            list_of_potential_relations = left_element.GetRelationTo(
                right_element)
...
class CF_IsThisAnInterlacedSequence(CodeletFamily):
    ...
    def Run(cls, controller, *, me):
        ...
        # If all of them are mappings, we will try to impose this view of the
        # sequence on it.
    ...
    def CreateGroupings(cls, controller, *, me):
        ...
        for k in range(number_of_groups_possible):
            items = [parent_workspace.elements[x]
            ...
            try:
                ...
                # TODO(# --- Apr 22, 2012): add an appropriate codelet in top
                # workspace.
                pass
...
class CF_LookForUndiscoveredMappings(CodeletFamily):
    ...
    @classmethod
    def Run(cls, controller, *, me):
        missing_positions = CF_LookForUndiscoveredMappings.FindMissingMapping(
            controller)
