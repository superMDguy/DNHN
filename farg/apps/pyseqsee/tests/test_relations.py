...
class TestRelations(unittest.TestCase):
    ...
    def test_sanity(self):
        ...
        self.assertEqual(r, o1.GetRelationTo(
            o2), 'You get back the same relation')
        self.assertNotEqual(r,
                            o2.GetRelationTo(o1),
                            'Not the same relation in the reverse direction')

        self.assertIsInstance(
            o1.GetRelationTo(o1), PSRelation, 'Self relations are fine')
    ...
    def test_arena_merge(self):
        ...
        self.assertFalse(a.element[0].GetRelationTo(a.element[1])
                         .IsKnownAsInstanceOf(SameStructureReln()))
        self.assertFalse(a.element[1].GetRelationTo(a.element[2])
                         .IsKnownAsInstanceOf(SameStructureReln()))

        a.MergeObject(gp)
        self.assertTrue(a.element[0].GetRelationTo(a.element[1])
                        .IsKnownAsInstanceOf(SameStructureReln()))
        self.assertTrue(a.element[1].GetRelationTo(a.element[2])
                        .IsKnownAsInstanceOf(SameStructureReln()))
