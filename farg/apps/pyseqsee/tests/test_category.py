...
class TestMultipartCategory(unittest.TestCase):
    ...
    def test_instancehood(self):
        ...
        # interesting.
        # Plus, this would be a prime case for multiple logics for
        # instancehood...
...
class TestRepeatedIntegerCategory(unittest.TestCase):
    ...
    def test_categories_on_logic(self):
        ...
        self.assertTrue(logic.Attributes()[
                        'magnitude'].IsKnownAsInstanceOf(CategoryPrime()))
...
class TestCompoundCategory(unittest.TestCase):
    ...
    def test_instancehood(self):
        ...
        # In creation, attribute_categories must be sorted and contain
        # categories.
        self.assertRaises(C.BadCategorySpec,
                          C.CompoundCategory,
