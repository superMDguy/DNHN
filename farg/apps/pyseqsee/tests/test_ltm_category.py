...
class LTMTestBase(unittest.TestCase):
    ...
    def assert_dump_and_revive(self, *, nodecount, class_name, arguments_creator=None,
        ...
        self.assertEqual(len(graph2.GetNodes()),
                         node_count_before, "Node existed")
    ...
    def test_multipart(self):
        classes_to_clear = (CategoryEvenInteger,
                            C.CategoryAnyObject, C.MultiPartCategory)
    ...
    def test_compound(self):
        classes_to_clear = (C.BasicSuccessorCategory,
                            C.RepeatedIntegerCategory, C.CompoundCategory)
