...
class LTMNode(object):
    ...
    def __getstate__(self):
        ...
        attrib_dict = dict(kv for kv in content.__dict__.items()
    ...
    def __setstate__(self, state):
        ...
        # Fair use of ** magic. pylint: disable=W0142
    ...
    def IncreaseActivationButDontSpread(self, amount, *, current_time):
        ...
        kLogger.debug("Raw activation of %s now %5.3f",
                      self, self._raw_activation)
    ...
    def IncreaseActivation(self, amount, *, current_time):
        ...
        for edge in self.outgoing_edges:
            ...
            to_node.IncreaseActivationButDontSpread(
                0.25 * amount, current_time=current_time)
